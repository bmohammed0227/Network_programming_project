...
public class Controller implements Initializable{
    ...
    private void result(int response) throws IOException {
		...
		//failed inscription
		break;
		case 1: alert.setHeaderText("Le pseudo que vous avez entrer existe déjà.");
		break;
		case 2: alert.setHeaderText("L'email que vous avez entrer existe déjà.");
		break;
		//failed connection
		case 3: alert.setHeaderText("Pseudo erroné.");
		break;
		case 4: alert.setHeaderText("mot de passe erroné.");
		break;
		}
    	if(alert!=null) alert.show();
	}
